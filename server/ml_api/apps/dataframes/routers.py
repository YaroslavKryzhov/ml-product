...
from ml_api.apps.dataframes import schemas, specs, models
...
async def upload_dataframe(
    ...
    """
        ...
        - **file**: csv-файл
    """
    return await DataframeFileManagerService(user.id).upload_file(
...
async def rename_dataframe(
    ...
    """
    return await DataframeFileManagerService(user.id).rename_file(dataframe_id, new_filename)
