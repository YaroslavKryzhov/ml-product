...
class DataframeFunctionService:
    ...
    #         feature_selection.SimpleImputer(strategy='most_frequent').fit_transform(
    ...
    #     numeric_columns = self.column_types.numeric
    #     self.df[numeric_columns] = pd.DataFrame(
    #         feature_selection.IterativeImputer().fit_transform(self.df[numeric_columns]),
    #         self.df.index,
    #         numeric_columns,
    #     )
    #
    ...
    #     numeric_columns = self.column_types.numeric
    #     self.df[numeric_columns] = pd.DataFrame(
    #         feature_selection.KNNImputer().fit_transform(self.df[numeric_columns]),
    #         self.df.index,
    #         numeric_columns,
    #     )
    #
    ...
    #         self.miss_insert_mean_mode()
    #     self.df[categorical] = preprocessing.OrdinalEncoder().fit_transform(
    #         self.df[categorical]
    #     )
    ...
    #     if self.check_nans(numeric_columns):
    #         self.miss_insert_mean_mode()
    #     outliers = ensemble.IsolationForest().fit_predict(self.df[numeric_columns])
    ...
    #     if self.check_nans(numeric_columns):
    #         self.miss_insert_mean_mode()
    #     outliers = covariance.EllipticEnvelope().fit_predict(self.df[numeric_columns])
    #     self.df = self.df.loc[outliers == 1].reset_index(drop=True)
    #
    ...
    #     if self.check_nans(numeric_columns):
    #         self.miss_insert_mean_mode()
    #     outliers = neighbors.LocalOutlierFactor().fit_predict(self.df[numeric_columns])
    #     self.df = self.df.loc[outliers == 1].reset_index(drop=True)
    #
    ...
    #     if self.check_nans(numeric_columns):
    #         self.miss_insert_mean_mode()
    #     outliers = svm.OneClassSVM().fit_predict(self.df[numeric_columns])
    #     self.df = self.df.loc[outliers == 1].reset_index(drop=True)
    #
    ...
    #     if self.check_nans(numeric_columns):
    #         self.miss_insert_mean_mode()
    #     outliers = linear_model.SGDOneClassSVM().fit_predict(self.df[numeric_columns])
    #     self.df = self.df.loc[outliers == 1].reset_index(drop=True)
    #
