...
class ModelProcessingManagerService:
    ...
    def train_model(self, model_meta: ModelMetadata, model):
        ...
        try:
            ...
            self.metadata_manager.set_status(model_id, specs.ModelStatuses.PROBLEM)
            raise e
